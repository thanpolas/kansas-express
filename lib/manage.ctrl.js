  ...
  this.kansas.get(token)
    ...
    .then(function(result) {
      if (req.kansas.ownerId !== result.ownerId) {
        ...
        return this.options.handleError(res, error);
      }
      this.options.handleSuccess(res, result, Manage.Action.READ_ONE);
    })
    .catch(function(err) {
...
Manage.prototype._del = function(req, res) {
  ...
  this.kansas.get(token)
    ...
    .then(function(result) {
      ...
      return this.kansas.del(result.token)
        .bind(this)
        .then(function() {
          this.options.handleSuccess(res, result, Manage.Action.DELETE);
        });
    }).catch(function(err) {
...
Manage.prototype._create = function(req, res) {
  this.kansas.create(req.kansas)
    .bind(this)
    .then(function(result) {
      this.options.handleSuccess(res, result, Manage.Action.CREATE);
    })
    .catch(function(err) {
      ...
      if(err instanceof this.kansas.error.Policy) {
