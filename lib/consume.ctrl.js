 ...
 * Middleware export.
 *
 * @param {Object=} optOptions Options to configure the controller.
 * @return {Function} The middleware.
 */
Consume.prototype.use = function(optOptions) {
  var userOpts = optOptions || {};
  this.options = {
    consumeUnits: 1,
  ...
  this.options = __.defaults(userOpts, this.options);
